...
export const MaterialUploadDetailModal = ({ isOpen, onClose, batch }) => {
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        {batch.status === "Processing" && (
          ...
          >
            ...
            <span style={{ fontSize: "14px", color: "var(--neutral-on-surface-primary)" }}>
              <strong>Import in progress:</strong> Your materials are being added to the material catalog. We’ll notify you by email when it’s complete.
            </span>
          </div>
        )}
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px" }}>
            ...
            <LabelValue label="Total Data" value={batch.totalMaterials} />
