const INDONESIAN_EXACT_TEXT = {
  ...
  "Add Material": "Tambah Bahan Baku",
  "Please add at least one material": "Tambahkan setidaknya satu bahan baku.",
  "Unknown Material": "Bahan Baku Tidak Dikenal",
  "No materials added yet. Click \"Add Material\" to get started.": "Belum ada bahan baku. Klik \"Tambah Bahan Baku\" untuk memulai.",
  ...
  "No materials added to this BOM.": "Belum ada bahan baku pada BOM ini.",
  ...
  "No material requests found.": "Tidak ada permintaan bahan baku yang ditemukan.",
  "Some materials are expired": "Beberapa bahan baku sudah kedaluwarsa",
  "Review your stock to avoid incorrect allocation.": "Periksa stok untuk menghindari alokasi yang tidak sesuai.",
  "Some material stocks are changed": "Stok beberapa bahan baku telah berubah",
  "Some material stocks are changed and expired": "Stok beberapa bahan baku telah berubah dan kedaluwarsa",
  "Request not found.": "Permintaan tidak ditemukan.",
  "Back to Material Request": "Kembali ke Permintaan Bahan Baku",
  ...
  "Material batch successfully updated": "Batch bahan baku berhasil diperbarui",
  "Request successfully confirmed": "Permintaan berhasil dikonfirmasi",
  "Request successfully canceled": "Permintaan berhasil dibatalkan",
  "Material request successfully completed": "Permintaan bahan baku berhasil diselesaikan",
  "Request Detail": "Detail Permintaan",
  "Request Canceled": "Permintaan Dibatalkan",
  "This material request has been canceled and will not proceed further.": "Permintaan bahan baku ini telah dibatalkan dan tidak akan diproses lebih lanjut.",
  "Requested Material": "Bahan Baku yang Diminta",
  ...
  "Review Material Preparation": "Tinjau Persiapan Bahan Baku",
  ...
  "Select an existing PO if it is already known. If left empty, you can add the PO later.": "Pilih Purchase Order yang sudah ada jika tersedia. Jika dikosongkan, kamu dapat menambahkannya nanti.",
  "View Request History": "Lihat Riwayat Permintaan",
  "No": "No.",
  "Quick Add Required Materials": "Tambahkan Bahan Baku dari BOM",
  "Apply Remaining BOM": "Gunakan Sisa Kebutuhan BOM",
  "Select Material": "Pilih Bahan Baku",
  ...
  "This will replace current selections with all required": "Tindakan ini akan mengganti pilihan saat ini dengan seluruh bahan baku yang dibutuhkan",
  ...
  "Available: -": "Tersedia: -",
  "Add a vendor to assign outsourced output. You can also add Internal from the Add Vendor modal.": "Tambahkan vendor untuk menangani hasil outsourcing. Kamu juga dapat menambahkan Internal melalui dialog Tambah Vendor.",
  ...
  "Some materials are no longer available. Please refresh the updated stock before continuing.": "Beberapa bahan baku sudah tidak tersedia lagi. Silakan muat ulang data stok terbaru sebelum melanjutkan.",
  ...
  "Sum of BOM qty × avg stock cost per material": "Total kuantitas BOM × rata-rata biaya stok setiap bahan baku.",
  ...
  "The quantity of material submitted by production": "Jumlah bahan baku yang diajukan oleh tim produksi.",
  "The quantity allocated based on current stock availability": "Jumlah bahan baku yang dialokasikan berdasarkan ketersediaan stok saat ini.",
  ...
  "Material replacement": "Penggantian Bahan Baku",
  ...
  "Testing a new material or process not yet in the standard BOM": "Menguji bahan baku atau proses baru yang belum tercantum pada BOM standar.",
  "Product design was updated and needs a new material": "Desain produk diperbarui sehingga memerlukan bahan baku baru.",
  ...
  "Some material will be lost during cutting, shaping, or processing": "Sebagian bahan baku akan terbuang selama proses pemotongan, pembentukan, atau pengolahan.",
  "Extra needed for testing or inspection samples": "Tambahan bahan baku diperlukan untuk pengujian atau sampel inspeksi.",
  "Keeping extra in case of shortage or delay": "Menyiapkan tambahan bahan baku sebagai cadangan jika terjadi kekurangan atau keterlambatan.",
...
const INDONESIAN_DYNAMIC_TEXT = [
  ...
  },
  {
    ...
    replacer: (_, n) => `${n} bahan baku telah kedaluwarsa. Tetap konfirmasi penerimaan?`,
  },
  {
    pattern: /^(\d+) Materials Shortage$/i,
    replacer: (_, n) => `Kekurangan ${n} Bahan Baku`,
  },
  {
    pattern: /^You have (\d+) shortage materials from\s*(.*)$/i,
    replacer: (_, n, id) => `Terdapat kekurangan ${n} bahan baku pada ${id}`.trim(),
  },
  {
